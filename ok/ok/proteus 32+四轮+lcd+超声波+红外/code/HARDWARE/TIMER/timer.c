...
float Hcsr04GetLength_2(void)
{
	...
	msHcCount_2 = 0;
        while(i<2)
        {
		TRIG_Send_2(1);      //发送口高电平输出
		Delay_Us(20);
		TRIG_Send_2(0);

		while(ECHO_Reci_2 == 0);      //等待接收口高电平输出
